...
print(args)
exprFile <- args[1]
#exprFile <- '/Users/jcasalet/Desktop/RESEARCH/LIVER/DATA/JC/SOUP2NUTS/expr.csv'
outFile <- args[2]
#outFile <- '/Users/jcasalet/Desktop/RESEARCH/LIVER/DATA/JC/SOUP2NUTS/expr_mapped.csv'
