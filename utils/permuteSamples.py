...
def parse_args():
    ...
    parser.add_argument('-ek', '--expr_key', help='expr file key', default=None)
    parser.add_argument('-m', '--meta_file', help='metadata file', default=None)
    parser.add_argument('-mk', '--meta_key', help='metadata file key', default=None)
