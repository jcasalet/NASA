...
TO_BRIDGE_FROM_COLABSHIM=/home/fluid/FROM_COLABSHIM
TO_BRIDGE_FROM_TDS=/home/fluid/FROM_TDS
TO_TDS_FROM_ISS=/home/fluid/FROM_ISS
TO_TDS_FROM_BRIDGE=/home/fluid/FROM_BRIDGE
...
`	fi
	...
	do
		...
		colab-shim_running=$(echo $?)
		ssh fluid@tds [ -d $TO_TDS_FROM_ISS ]
		tds_running=$(echo $?)
		if [ $colab-shim_running == 0 -a $tds_running == 0 ]
		then
			break
		else
...
`	fi
	...
	do
		...
		rsync -a $TO_TDS_FROM_BRIDGE/ $TO_ISS_FROM_BRIDGE/ 
